        ...
        stage('Check for package.json') {
            steps {
                script {
                    ...
                    def projectDir = "C:\\Users\\Dell-Lap\\Downloads\\react-hello-world-master\\react-helloworld-master"
        ...
        stage('Deploy') {
            steps {
                script {
                    ...
                    bat 'xcopy /S /I /Y "C:\\Users\\Dell-Lap\\Downloads\\react-hello-world-master\\react-helloworld-master\\build\\*" "C:\\Users\\Dell-Lap\\Downloads\\node\\"'
